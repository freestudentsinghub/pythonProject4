...
# 1998-06-28 fl   Handle I and F media
...
"""
A simple 2D drawing interface for PIL media.
<p>
...
class ImageDraw:
    ...
    def __init__(self, im: Image.Image, mode: str | None = None) -> None:
        ...
        :param mode: Optional mode to use for color values.  For RGB
           media, this argument can be RGB or RGBA (to blend the
        ...
        if mode in ("I", "F"):
            ...
            self.ink = self.draw.draw_ink(-1)
        if mode in ("1", "P", "I", "F"):
            # FIXME: fix Fill2 to properly support matte for I+F media
            self.fontmode = "1"
        else:
