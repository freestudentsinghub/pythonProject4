...
OPEN_INFO = {
    ...
    (II, 6, (1,), 1, (8,), ()): ("L", "L"),
    (MM, 6, (1,), 1, (8,), ()): ("L", "L"),
    # JPEG compressed media handled by LibTiff and auto-converted to RGBX
    # Minimal Baseline TIFF requires YCbCr media to have 3 SamplesPerPixel
...
class TiffImageFile(ImageFile.ImageFile):
    ...
    def _seek(self, frame: int) -> None:
        ...
        while len(self._frame_pos) <= frame:
            if not self.__next:
                msg = "no more media in TIFF file"
                raise EOFError(msg)
            logger.debug(
    ...
    def _setup(self) -> None:
        ...
        # old style jpeg compression media most certainly are YCbCr
        ...
        if self.use_load_libtiff:
            ...
            # so large g4 media will fail if we use that
            # function.
            #
            ...
            # YCbCr media with new jpeg compression with pixels in one plane
...
def _save(im: Image.Image, fp: IO[bytes], filename: str | bytes) -> None:
    ...
    # required for color libtiff media
