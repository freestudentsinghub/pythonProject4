...
# 1998-07-12 fl   Read/write 16-bit media as mode I (0.4)
...
# 2008-08-13 fl   Added tRNS support for RGB media
    ...
    def seek(self, frame: int) -> None:
        ...
        for f in range(self.__frame + 1, frame + 1):
            try:
                ...
                msg = "no more media in APNG file"
...
def _save(
    ...
    if mode == "P":
        #
        # attempt to minimize storage requirements for palette media
