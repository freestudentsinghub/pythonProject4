...
class Image(DisplayObject):
    ...
    def __init__(
        ...
        embed : bool
            ...
            Note that QtConsole is not able to display media if `embed` is set to `False`
        ...
        retina : bool
            ...
            width and height.
            This only works for embedded media because it reads the width/height
            from image data.
            For non-embedded media, you can just set the desired display width
            and height directly.
        ...
        The result is always embedding image data for inline media.
