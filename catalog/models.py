...
class Product(models.Model):
    ...
    category = models.CharField(max_length=150, verbose_name='Название категории продукта', help_text='Введите название категории', blank=True, null=True)
    cost = models.IntegerField(verbose_name='цена за покупку', help_text='Введите цену')
